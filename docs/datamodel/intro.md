...
The **ARES Datamodel** is the foundational schema layer that defines how components within ARES communicate, store state, and define experimental workflows. It is built entirely on [**Protocol Buffers (v3)**](https://protobuf.dev/programming-guides/proto3/), enabling language-agnostic serialization, high-performance gRPC services, and a robust type system optimized for autonomous science.
